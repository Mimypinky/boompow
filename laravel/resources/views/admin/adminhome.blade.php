  ...
  <div class="main-page">
    <div class="row-one">
      ...
      <div class="col-md-4" style="color:#fff;text-align:center">
        <div class="col-xs-8 " style="background-color: #47b8e0;">

          <h3>Contents</h3>
        </div>
        <div class="col-xs-4" style="background-color: #5acbf3;">
          <h3> {{$c_content}}</h3>
        </div>
      ...
      <div class="col-md-4  states-mdl" style="color:#fff;text-align:center">
        <div class="col-xs-8" style="background-color: #ffc952;">

          <h3>Event</h3>
        </div>
        <div class="col-xs-4" style="background-color: #ffd16d;" >
          <h3>{{$c_event}}</h3>
        </div>
        <div class="col-xs-12"style="background-color: #77919d;text-align:left">
      ...
      <div class="col-md-4  states-last" style="color:#fff;text-align:center">
        <div class="col-xs-8" style="background-color: #ff7473;">

          <h3>Users</h3>
        </div>
        <div class="col-xs-4" style="background-color: #fd8d8d;">
          <h3>{{$c_acc}}</h3>
        </div>
        <div class="col-xs-12"style="background-color: #77919d;text-align:left">
